        ...
        <div className="min-h-screen bg-linear-to-b from-green-50 to-white pt-24 pb-16">
            <div className="w-11/12 md:w-11/12 mx-auto">
                ...
                <div className="mt-10 bg-white rounded-2xl shadow-xl p-6 md:p-10">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                        ...
                        <div className="mt-4 md:mt-0">
                            <button onClick={handleNavigateToJoin} className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg shadow-md transition-all duration-200 cursor-pointer">Join Challenge</button>
                        </div>
                    </div>
                ...
                <div className="mt-12 text-center bg-green-100 rounded-2xl p-10 shadow-inner">
                    ...
                    <button onClick={handleNavigateToJoin} className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105 cursor-pointer"> Join the Challenge Now</button>
                </div>
            </div>
        </div>
    );
