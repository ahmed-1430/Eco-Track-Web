...
const Register = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "password") validatePasswordInline(value);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-100 via-white to-green-50 px-4 pt-20">
      <div className="w-full max-w-md bg-white/80 backdrop-blur-md border border-green-100 shadow-2xl rounded-2xl p-8 md:p-10 transition-transform hover:scale-[1.02] duration-300">
        ...
        <h1 className="text-3xl font-bold mb-6 text-center text-green-700">
          Join <span className="text-green-800">EcoTrack</span>
        </h1>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div className="relative">
            ...
            <input type="text" name="name" placeholder="Full Name"
              ...
              className="w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition" />
          </div>
          ...
          <div className="relative">
            ...
            {passwordError && (
              <p className="text-red-500 text-sm mt-1 pl-1 animate-fadeIn">
                {passwordError}
              </p>
            )}
          </div>
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-linear-to-r from-green-600 to-emerald-500 text-white py-2 rounded-lg font-semibold hover:opacity-90 shadow-md transition duration-200 cursor-pointer">
        ...
        <button onClick={handleGoogleRegister} disabled={loading}
          className="w-full flex items-center justify-center gap-2 border py-2 rounded-lg hover:bg-gray-100 transition font-medium text-gray-700 cursor-pointer">
          <FcGoogle size={22} />
